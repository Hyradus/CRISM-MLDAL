                ...
                if fname.endswith(".hdr"):
                    ...
                    for i in range(len(HDR['default bands'])):
                        if IDX[i][0] in SPIDX and SPIDX.get(IDX[i][0]) == [255, 255]:
                            ...
                            cv.imwrite(SAVEPATH + savename + '.png', BANDor.astype('uint8'))
                            BANDor.dump(SAVEPATH + savename)
                            ...
                            cv.imwrite(SAVEPATH + savename + '.png', BANDth.astype('uint8'))
                            np.save(SAVEPATH + savename, BANDth)
