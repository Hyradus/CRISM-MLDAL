...
# def main(featnonan, features, tgt, answer):    
def main(featnonan, features):
...
from sklearn.tree import DecisionTreeClassifier
 ...
 featImpDf = pd.DataFrame()
    featImpDf['Decision Trees'] = pd.Series(tree.feature_importances_,index=dataset.columns).sort_values(ascending=False)
